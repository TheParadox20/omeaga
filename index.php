                    ...
                    <div class="col-lg-10 col-md-10">
                        <div class="slider_text">
                            <h3 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s">
                                Our main goal is to always achieve a high level of customer satisfaction
                            </h3>
                            <a class="boxed-btn3 wow fadeInLeft"  data-wow-duration="1s" data-wow-delay=".2s" href="reg.php">Join Us</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb-70">
                        ...
                        <h3 class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s">We Take Care of Your Car <br>
                            Fast, Professional and Reliable Service</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-4 col-md-4">
                    <div class="single_service text-center wow fadeInLeft" data-wow-duration="1.2s" data-wow-delay=".4s">
                        <div class="icon">
                            <img src="img-startup/svg_icon/1.svg" alt="">
                        </div>
                        <h3>Hire A Mechanic</h3>
                        <p>Lorem ipsum dolor sit amet, conseGraphic design<ctetur adipiscing elit sed do eiusmod tempor.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="single_service text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                        <div class="icon">
                            <img src="img-startup/svg_icon/2.svg" alt="">
                        </div>
                        <h3>Online Store</h3>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_service text-center wow fadeInRight" data-wow-duration="1.2s" data-wow-delay=".4s">
                        <div class="icon">
                            <img src="img-startup/svg_icon/3.svg" alt="">
                        </div>
                    ...
                    <div class="work_info">
                        ...
                        <div class="video_watch d-flex align-items-center">
                            <div class="play_btn wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                                <a href="https://youtu.be/vEbbq3HML7k" class="video_icon popup-video"> <i class="fa fa-play"></i> </a>
                            </div>
                    ...
                    <div class="testmonial_active owl-carousel">
                        <div class="single_carousel">
                                <div class="single_testmonial text-center">
                                        <div class="quote">
                                            <img src="img-startup/testmonial/quote.svg" alt="">
                                        </div>
                                        ...
                                        <div class="testmonial_author">
                                            <div class="thumb">
                                                    <img src="img-startup/testmonial/thumb.png" alt="">
                                            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-2 col-md-3">
                        <div class="footer_logo wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">
                            <a href="index.php">
                                <img src="img-startup/logo.png" alt="">
                            </a>
                        </div>
                    </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!-- JS here -->
    <script src="js-startup/vendor/modernizr-3.5.0.min.js"></script>
    <script src="js-startup/vendor/jquery-1.12.4.min.js"></script>
    <script src="js-startup/popper.min.js"></script>
    <script src="js-startup/bootstrap.min.js"></script>
    <script src="js-startup/owl.carousel.min.js"></script>
    <script src="js-startup/isotope.pkgd.min.js"></script>
    <script src="js-startup/ajax-form.js"></script>
    <script src="js-startup/waypoints.min.js"></script>
    <script src="js-startup/jquery.counterup.min.js"></script>
    <script src="js-startup/imagesloaded.pkgd.min.js"></script>
    <script src="js-startup/scrollIt.js"></script>
    <script src="js-startup/jquery.scrollUp.min.js"></script>
    <script src="js-startup/wow.min.js"></script>
    <script src="js-startup/nice-select.min.js"></script>
    <script src="js-startup/jquery.slicknav.min.js"></script>
    <script src="js-startup/jquery.magnific-popup.min.js"></script>
    <script src="js-startup/plugins.js"></script>
    <script src="js-startup/gijgo.min.js"></script>

    <!--contact js-->
    <script src="js-startup/contact.js"></script>
    <script src="js-startup/jquery.ajaxchimp.min.js"></script>
    <script src="js-startup/jquery.form.js"></script>
    <script src="js-startup/jquery.validate.min.js"></script>
    <script src="js-startup/mail-script.js"></script>
